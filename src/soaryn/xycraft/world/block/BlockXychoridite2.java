...
public class BlockXychoridite2 extends BlockWorld implements IAnimationSideHandler {

   public BlockXychoridite2(int id, int icon) {
   ...
   public float getBlockHardness(World world, int x, int y, int z) {
      return world.getBlockMetadata(x, y, z) < 5?0.2F:16.0F;
   }

   public float getExplosionResistance(Entity par1Entity, World world, int x, int y, int z, double explosionX, double explosionY, double explosionZ) {
      return world.getBlockMetadata(x, y, z) < 5?10.0F:112.0F;
   }
   ...
   public Colour getColor(IBlockAccess iBlockAccess, int x, int y, int z, ForgeDirection side) {
      return XyReferences.xyColors[iBlockAccess.getBlockMetadata(x, y, z) % 5];
   }
   ...
   public Colour getItemColor(int meta, ForgeDirection side) {
      return XyReferences.xyColors[meta % 5];
   }
